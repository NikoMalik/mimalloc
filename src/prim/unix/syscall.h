...
// NOTE: only for x86_64 complete full
...
static inline int mi_syscall_error(long result) {
    return (result < 0) ? (int)(-result) : 0;
}
static inline int mi_os_error(void) {
    return mi_syscall_error(-1);
}

static inline int mi_os_error_from(long result) {
    return mi_syscall_error(result);
}
...
// huge page size encodings (Linux)
...
#define syscall0(nr) \
    ({ long _ret; \
       __asm__ volatile ("syscall" : "=a"(_ret) : "a"(nr) : "rcx","r11","memory"); \
       _ret; })

#define syscall1(nr, a1) \
    ({ long _ret; \
       __asm__ volatile ("syscall" : "=a"(_ret) : "a"(nr),"D"(a1) : "rcx","r11","memory"); \
       _ret; })

#define syscall2(nr, a1, a2) \
    ({ long _ret; \
       __asm__ volatile ("syscall" : "=a"(_ret) : "a"(nr),"D"(a1),"S"(a2) : "rcx","r11","memory"); \
       _ret; })

#define syscall3(nr, a1, a2, a3) \
    ({ long _ret; \
       __asm__ volatile ("syscall" : "=a"(_ret) : "a"(nr),"D"(a1),"S"(a2),"d"(a3) : "rcx","r11","memory"); \
       _ret; })

#define syscall4(nr, a1, a2, a3, a4) \
    ({ register long _r10 asm("r10") = (long)(a4); \
       long _ret; \
       __asm__ volatile ("syscall" : "=a"(_ret) : "a"(nr),"D"(a1),"S"(a2),"d"(a3),"r"(_r10) : "rcx","r11","memory"); \
       _ret; })
...
#define syscall5(nr, a1, a2, a3, a4, a5) \
    ({ register long _r10 asm("r10") = (long)(a4); \
       ...
       long _ret; \
       __asm__ volatile ("syscall" : "=a"(_ret) : "a"(nr),"D"(a1),"S"(a2),"d"(a3),"r"(_r10),"r"(_r8) : "rcx","r11","memory"); \
       _ret; })
...
#define syscall6(nr, a1, a2, a3, a4, a5, a6) \
    ({ register long _r10 asm("r10") = (long)(a4); \
       ...
       long _ret; \
       __asm__ volatile ("syscall" : "=a"(_ret) : "a"(nr),"D"(a1),"S"(a2),"d"(a3),"r"(_r10),"r"(_r8),"r"(_r9) : "rcx","r11","memory"); \
       _ret; })
...
#define syscall3(nr, a1, a2, a3) \
    ({ long _ret; \
       __asm__ volatile ("int $0x80" : "=a"(_ret) : "a"(nr),"b"(a1),"c"(a2),"d"(a3) : "memory"); \
       _ret; })

#elif defined(__aarch64__)

#define syscall0(nr) \
    ({ register long _x8  asm("x8")  = (nr); \
...
#define syscall3(nr, a1, a2, a3) \
    ({ register long _x8  asm("x8")  = (nr); \
       ...
       __asm__ volatile ("svc #0" : "=r"(_x0) : "r"(_x8),"0"(_x0),"r"(_x1),"r"(_x2) : "memory"); \
       _x0; })

#else
#error "Raw syscalls not supported on this architecture"
#endif

//------------mmap, munmap,mprotect--------------------------------
#define mmap(addr, len, prot, flags, fd, off) \
    ((void *)syscall6(SYS_mmap, (long)(addr), (long)(len), (long)(prot), (long)(flags), (long)(fd), (long)(off)))

#define munmap(addr, len) \
    (syscall2(SYS_munmap, (long)(addr), (long)(len)))

#define mprotect(addr, len, prot) \
    (syscall3(SYS_mprotect, (long)(addr), (long)(len), (long)(prot)))

#define madvise(addr, length, advice) \
    syscall3(SYS_madvise, (long)addr, (long)length, (long)advice)

// ----------------open, read, close, access,and other posix commands------------------------
#define open(fpath, open_flags) \
    syscall3(SYS_open, (long)(fpath), (long)(open_flags), 0)

#define read(fd, buf, bufsize) \
    syscall3(SYS_read, (long)(fd), (long)(buf), (long)(bufsize))

#define close(fd) \
    syscall1(SYS_close, (long)(fd))

#define access(fpath, mode) \
    syscall2(SYS_access, (long)(fpath), (long)(mode))

#define prctl(option, arg2, arg3, arg4, arg5) \
    syscall5(SYS_prctl, (long)option, (long)arg2, (long)arg3, (long)arg4, (long)arg5)

/* wait wrappers */
/* waitpid -> wait4 with options translated; prefer wait4 syscall for both */
#define waitpid_raw(pid, status_ptr, flags) \
    syscall4(SYS_wait4, (long)(pid), (long)(status_ptr), (long)(flags), 0)

#define waitpid(pid, status_ptr, flags) \
    waitpid_raw(pid, status_ptr, flags)

#define wait4(pid, status_ptr, flags, usage_ptr) \
    syscall4(SYS_wait4, (long)(pid), (long)(status_ptr), (long)(flags), (long)(usage_ptr))

#define waitid(idtype, id, infop, options) \
    syscall5(SYS_waitid, (long)(idtype), (long)(id), (long)(infop), (long)(options), 0)

#ifdef SYS_fcntl64
#define fcntl(fd, cmd, arg) \
    syscall3(SYS_fcntl64, (long)(fd), (long)(cmd), (long)(arg))
#else
#define fcntl(fd, cmd, arg) \
    syscall3(SYS_fcntl, (long)(fd), (long)(cmd), (long)(arg))
#endif

#define flock(fd, operation) \
    syscall2(SYS_flock, (long)(fd), (long)(operation))

/* unlinkat */
#define unlinkat(dirfd, path, flags) \
    syscall3(SYS_unlinkat, (long)(dirfd), (long)(path), (long)(flags))

/* ---------------- time / sleep ---------------- */
/* clock_gettime: prefer VDSO in userland; as macro we only provide syscall fallback */
/* detect clock_gettime vs clock_gettime64 syscall name if present */
#if defined(SYS_clock_gettime)
#define clock_gettime(clk, tp) syscall2(SYS_clock_gettime, (long)(clk), (long)(tp))
#elif defined(SYS_clock_gettime64)
#define clock_gettime(clk, tp) syscall2(SYS_clock_gettime64, (long)(clk), (long)(tp))
#else
/* if neither syscall macro present, you may need to define it for your platform */
#endif

/* clock_getres / clock_settime / clock_nanosleep choose 64-bit variants if available */
#if defined(SYS_clock_getres)
#define clock_getres(clk, tp) syscall2(SYS_clock_getres, (long)(clk), (long)(tp))
#elif defined(SYS_clock_getres_time64)
#define clock_getres(clk, tp) syscall2(SYS_clock_getres_time64, (long)(clk), (long)(tp))
#endif

#if defined(SYS_clock_settime)
#define clock_settime(clk, tp) syscall2(SYS_clock_settime, (long)(clk), (long)(tp))
#elif defined(SYS_clock_settime64)
#define clock_settime(clk, tp) syscall2(SYS_clock_settime64, (long)(clk), (long)(tp))
#endif

#if defined(SYS_clock_nanosleep)
#define clock_nanosleep(clk, flags, req, rem) \
    syscall4(SYS_clock_nanosleep, (long)(clk), (long)(flags), (long)(req), (long)(rem))
#elif defined(SYS_clock_nanosleep_time64)
#define clock_nanosleep(clk, flags, req, rem) \
    syscall4(SYS_clock_nanosleep_time64, (long)(clk), (long)(flags), (long)(req), (long)(rem))
#endif

/* gettimeofday / settimeofday / nanosleep */
#define gettimeofday(tv, tz) syscall2(SYS_gettimeofday, (long)(tv), (long)(tz))

#define settimeofday(tv, tz) syscall2(SYS_settimeofday, (long)(tv), (long)(tz))

#if defined(SYS_nanosleep)
#define nanosleep(req, rem) syscall2(SYS_nanosleep, (long)(req), (long)(rem))
#else
/* fallback: use ppoll or similar if desired */
#endif

/* pause -> pause or ppoll fallback */
#ifdef SYS_pause
#define pause() syscall0(SYS_pause)
#else
#define pause() syscall4(SYS_ppoll, 0, 0, 0, 0)
#endif

/* ---------------- user/group ids ---------------- */
/* prefer *_32 variants if present on 32-bit legacy kernels */
#ifdef SYS_setuid32
#define setuid(uid) syscall1(SYS_setuid32, (long)(uid))
#else
#define setuid(uid) syscall1(SYS_setuid, (long)(uid))
#endif

#ifdef SYS_setgid32
#define setgid(gid) syscall1(SYS_setgid32, (long)(gid))
#else
#define setgid(gid) syscall1(SYS_setgid, (long)(gid))
#endif

/* getuid/getgid/geteuid/getegid -- return raw syscall value cast to uid_t/gid_t */
#ifdef SYS_getuid32
#define getuid() ((uid_t)syscall0(SYS_getuid32))
#else
#define getuid() ((uid_t)syscall0(SYS_getuid))
#endif

#ifdef SYS_getgid32
#define getgid() ((gid_t)syscall0(SYS_getgid32))
#else
#define getgid() ((gid_t)syscall0(SYS_getgid))
#endif

#ifdef SYS_geteuid32
#define geteuid() ((uid_t)syscall0(SYS_geteuid32))
#else
#define geteuid() ((uid_t)syscall0(SYS_geteuid))
#endif

#ifdef SYS_getegid32
#define getegid() ((gid_t)syscall0(SYS_getegid32))
#else
#define getegid() ((gid_t)syscall0(SYS_getegid))
#endif

/* setresuid/setresgid/getresuid/getresgid variants (32-bit compat) */
#if defined(SYS_getresuid32)
#define getresuid(a, b, c) syscall3(SYS_getresuid32, (long)(a), (long)(b), (long)(c))
#else
#define getresuid(a, b, c) syscall3(SYS_getresuid, (long)(a), (long)(b), (long)(c))
#endif

/* setresuid etc similar... omitted for brevity, follow same pattern */

/* ---------------- signals / threads ---------------- */
#define setsid() ((pid_t)syscall0(SYS_setsid))
#define getpid() ((pid_t)syscall0(SYS_getpid))
#define getppid() ((pid_t)syscall0(SYS_getppid))
#define gettid() ((pid_t)syscall0(SYS_gettid))

/* rt_sigprocmask */
#define sigprocmask(how, set, oldset) \
    syscall4(SYS_rt_sigprocmask, (long)(how), (long)(set), (long)(oldset), (NSIG / 8))

/* ---------------- resource usage ---------------- */
#define getrusage(who, usage) \
    syscall2(SYS_getrusage, (long)(who), (long)(usage))

/* --- VDSO clock_gettime support --- */
// timeval / timespec
struct timespec {
    int64_t tv_sec;
    int64_t tv_nsec;
...
static Elf64_auxv_t *mi_auxv = NULL;
...
static void mi_init_auxv(char **envp) {
    // get auxv from stack
    // in Linux: stack when start: argc → argv → envp → auxv
    char **p = envp;
    while (*p != NULL)
        p++;
    mi_auxv = (Elf64_auxv_t *)(p + 1);

    for (int i = 0; mi_auxv[i].a_type != 0; i++) {
        switch (mi_auxv[i].a_type) {
        case AT_PAGESZ: // AT_PAGESZ
            page_size = (size_t)mi_auxv[i].a_un.a_val;
            break;
        case AT_SYSINFO_EHDR: // AT_SYSINFO_EHDR
            vdso_base = mi_auxv[i].a_un.a_val;
            break;
        }
    }
    if (page_size == 0)
...
static inline Elf64_auxv_t *mi_get_auxv(void) {
    return mi_auxv;
}

static inline size_t mi_auxv_page_size(void) {
    return page_size;
}

static inline unsigned long mi_auxv_get(unsigned long type) {
    for (int i = 0; mi_auxv[i].a_type != 0; i++) {
        if (mi_auxv[i].a_type == type)
            return mi_auxv[i].a_un.a_val;
    }
    return 0;
}

typedef long (*vdso_clock_gettime_t)(int, struct timespec *);

static vdso_clock_gettime_t vdso_clock_gettime = 0;

__attribute__((always_inline)) static void *
mi_vdso_lookup(const char *name) {
    Elf64_auxv_t *auxv = mi_get_auxv();
    if (!auxv)
        return NULL;
    // for (int i = 0; auxv[i].a_type != AT_NULL; i++) {
    //     if (auxv[i].a_type == AT_SYSINFO_EHDR) {
    //         vdso_base = auxv[i].a_un.a_val;
    //         break;
    //     }
    // }
    if (!vdso_base)
    ...
    Ehdr *eh = (Ehdr *)vdso_base;
    Phdr *ph = (Phdr *)(vdso_base + eh->e_phoff);

    unsigned long strtab = 0, symtab = 0, hash = 0;
    for (int i = 0; i < eh->e_phnum; i++) {
        if (ph[i].p_type == 2) { // PT_DYNAMIC
            unsigned long *d = (unsigned long *)(vdso_base + ph[i].p_offset);
            while (*d) {
                if (d[0] == 5)
                    strtab = d[1];
                if (d[0] == 6)
    ...
    if (!strtab || !symtab || !hash)
        return NULL;

    unsigned long nbucket = ((unsigned long *)(vdso_base + hash))[0];
    unsigned long *bucket = (unsigned long *)(vdso_base + hash + 8);
    unsigned long *chain = bucket + nbucket;

    for (unsigned long i = 0; i < nbucket; i++) {
        for (unsigned long j = bucket[i]; j; j = chain[j]) {
            Sym *sym = (Sym *)(vdso_base + symtab + j * sizeof(Sym));
            const char *symname = (const char *)(vdso_base + strtab + sym->st_name);
            if (str_equal(symname, name)) {
                return (void *)(vdso_base + sym->st_value);
            }
        }
    }
    return NULL;
...
__attribute__((always_inline)) static void vdso_init(void) {
    if (vdso_clock_gettime)
        return;
    vdso_clock_gettime = (vdso_clock_gettime_t)mi_vdso_lookup("__vdso_clock_gettime");
    if (!vdso_clock_gettime)
        vdso_clock_gettime = (vdso_clock_gettime_t)mi_vdso_lookup("__kernel_clock_gettime");
}

static long clock_gettime_vdso(int clk, struct timespec *ts) {
    vdso_init();
    if (vdso_clock_gettime) {
        long r = vdso_clock_gettime(clk, ts);
        if (r == 0 || r == -22)
            return r;
    }
    return clock_gettime(clk, (long)ts);
}
