...
mi_decl_cache_align const mi_heap_t _mi_heap_empty = {
    ...
    0,
    0,
    1, // count is 1 so we never write to it (see `internal.h:mi_heap_malloc_use_guarded`)
#endif
...
static mi_decl_cache_align mi_tld_t tld_main = {
    0, false, &_mi_heap_main, &_mi_heap_main, {MI_SEGMENT_SPAN_QUEUES_EMPTY, 0, 0, 0, 0, 0, &mi_subproc_default, &tld_main.stats}, // segments
    {MI_STAT_VERSION, MI_STATS_NULL}                                                                                               // stats
};
